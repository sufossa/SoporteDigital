                                                ...
                                                <tbody>
                                                    <c:forEach items="${lista}" var="item">
                                                        <tr>
                                                            ...
                                                            <c:if test="${sessionScope.tipoUsuario == 'S'}">
                                                                <td>
                                                                    <a href="cliente?accion=editar&id=${item.idUsuario}"
                                                                       class="btn btn-primary btn-sm">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <a href="cliente?accion=eliminar&id=${item.idUsuario}"
                                                                       onclick="return confirm('¿Está seguro que desea eliminar al usuario con ID ${item.idUsuario}?')"
